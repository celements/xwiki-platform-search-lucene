...
public class AttachmentData extends AbstractDocumentData {
  ...
  public AttachmentData(XWikiDocument doc, String fileName, boolean deleted) {
    super(LuceneDocType.attachment, createRef(doc, fileName), doc, deleted);
